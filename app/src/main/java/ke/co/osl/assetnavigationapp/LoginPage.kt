...
import ke.co.osl.assetnavigationapp.models.Message
import retrofit2.*
import android.util.Patterns
import android.widget.*
import androidx.constraintlayout.widget.ConstraintLayout
import androidx.lifecycle.lifecycleScope
import ke.co.osl.assetnavigationapp.models.RecoverPasswordBody
...
//        Theme_Black_NoTitleBar_Fullscreen - style theme changed from...
    ...
    private fun postLoginDetails(){
        ...
        submit.setOnClickListener {
            ...
            val loginBody = ke.co.osl.assetnavigationapp.models.LoginBody(
                email.text.toString(),
